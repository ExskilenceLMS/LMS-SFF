...
const TestSection: React.FC = () => {
    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          `https://staging-exskilence-be.azurewebsites.net/api/student/test/section/${studentId}/${testId}/`
        );
  ...
  const confirmSubmitTest = async () => {
    try {
      await axios.get(`https://staging-exskilence-be.azurewebsites.net/api/student/test/submit/${studentId}/${testId}/`);
...
//           <div className="d-flex justify-content-center mt-3">
//             <button className="btn btn-sm px-2 py-1 border border-black" onClick={handleSubmitTest} disabled={isSubmitting}>
//               {isSubmitting ? "Submitting..." : "Submit the Test"}
//             </button>
//           </div>
//         </div>
//       </div>
