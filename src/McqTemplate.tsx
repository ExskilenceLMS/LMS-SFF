...
const McqTemplate: React.FC = () => {
  ...
  useEffect(() => {
    const fetchQuestions = async () => {
      const url=`https://staging-exskilence-be.azurewebsites.net/api/student/test/questions/${studentId}/${testId}/mcq/`
      try {
  ...
  const handleSubmit = async () => {
    if (selectedOption) {
      ...
      const url="https://staging-exskilence-be.azurewebsites.net/api/student/test/questions/submit/mcq/"
      try {
        await axios.put(url, {
