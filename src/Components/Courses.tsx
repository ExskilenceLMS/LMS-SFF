...
//       try {
//         const url = `https://staging-exskilence-be.azurewebsites.net/api/studentdashboard/mycourses/${studentId}/`;
    ...
    const fetchCourses = async () => {
      try {
        ...
        if (axios.isAxiosError(error)) {
          ...
          <ErrorLogMethod url={`https://staging-exskilence-be.azurewebsites.net/api/studentdashboard/mycourses/${studentId}/`} body={axiosError.request?.data} response={axiosError.response?.data} />;
        } else {
