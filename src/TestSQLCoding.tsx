...
const TestSQLCoding: React.FC = () => {
  ...
  useEffect(() => {
    const fetchQuestions = async () => {
      const url=`https://staging-exskilence-be.azurewebsites.net/api/student/test/questions/${studentId}/${testId}/coding/`
      try {
  ...
  setProcessing(true);
  setIsSubmitted(true);
  const url= "https://staging-exskilence-be.azurewebsites.net/api/student/test/questions/submit/coding/"
  try {
    const postData = {
      student_id: studentId,
      test_id: testId,
