...
const TestSQLCoding: React.FC = () => {
    ...
    const fetchQuestions = async () => {
      try {
        const response = await axios.get(
          `https://staging-exskilence-be.azurewebsites.net/api/student/test/questions/${studentId}/${testId}/coding/`
        );
  ...
  try {
    ...
    const response = await axios.put(
      "https://staging-exskilence-be.azurewebsites.net/api/student/test/questions/submit/coding/",
      postData
    );
